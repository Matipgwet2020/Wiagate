...
const echeances = {
  ...
  forfait: ["3$/jour", "6$/jour","80$/mois", "110$/jour", "20,00"],
    ...
    <Document>
      <Page size="A4">
        <View style={styles.client}>
          ...
          <Text style={{ marginLeft: "10mm" }}>ENSP Yaoundé</Text>
          <Text style={{ marginLeft: "10mm" }}>Total melen</Text>
          <Text style={{ marginLeft: "10mm" }}>Tél : 656201331</Text>
          <Text style={{ marginLeft: "10mm" }}>Tél portable : 656201331</Text>
        </View>
        <View style={styles.seller}>
          <Text style={{ marginLeft: "131mm", marginTop: "36.4mm" }}>
            SASU MTEK
          </Text>
          <Text style={{ marginLeft: "131mm" }}>2, Avenue Emia</Text>
          <Text style={{ marginLeft: "131mm" }}>93420 ENSPY</Text>
        </View>
