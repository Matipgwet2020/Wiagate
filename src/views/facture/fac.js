                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="text-center text-150">
                                    ...
                                    <span class="text-default-d3">Facture</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div>
                                    ...
                                    <span class="text-600 text-110 text-blue align-middle">Orlaine Lekane</span>
                                </div>
                            ...
                            <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                                ...
                                <div class="text-grey-m2">
                                    ...
                                    <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Issue Date:</span> Jul 23, 2021</div>
